...
export default function Footer() {
  ...
  return (
    <footer className="bg-cinza-escuro border-t border-white/10 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            <span className="inline-flex items-center gap-1.5 bg-amarelo/10 border border-amarelo/30 text-amarelo text-xs font-semibold px-3 py-1.5 rounded-full">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="text-white/50 hover:text-verde text-sm transition-colors flex items-center gap-2"
              >
